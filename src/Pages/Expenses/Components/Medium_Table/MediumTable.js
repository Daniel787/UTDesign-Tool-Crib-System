...
function DataTable(props) {
  ...
  const head = ["Group ID", "Group Total", "NetID", "Student Total"];
  if (simpleList) {
    return (
      <div>
        ...
        <DownloadButton url={props.url} display="Medium_Expenses_" startDate={props.startDate} endDate={props.endDate} />
      </div>
    );
  } else {
    return <div> </div>;
