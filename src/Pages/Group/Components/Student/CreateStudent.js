...
export default function CreateStudent(props) {
    ...
    function handleSubmit(event) {
        ...
        Axios.post(url, {name : name, netid : netid, utdid : utdid, email : email}).then(
        );
        } 
    ...
    <React.Fragment>
      ...
      <Modal show={showCreateStudent}>
        ...
        <Modal.Body>
          ...
          <Form.Group>
            <Form.label onChange={e => setNetid(e.target.value)}type="number"> Net ID </Form.label>
            <Form.Control placeholder="Enter NET ID" />
          </Form.Group>
          <Form.Group>
            <Form.label onChange={e => setUtdid(e.target.value)} type="number"> UTD ID </Form.label>
            <Form.Control placeholder="Enter UTD ID" />
          </Form.Group>
          <Form.Group>
            <Form.label onChange={e => setEmail(e.target.value)} type="email"> Email </Form.label>
            <Form.Control placeholder="Enter email" />
          </Form.Group>
        </Modal.Body>
        <Modal.Footer>
             <Button variant="secondary" onClick={createStudentOff}> Close </Button>
